...
public class Version4UpdateLogFragment extends Fragment {
    ...
    private FragmentVersion4UpdateLogBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        //初始化binding
        binding = FragmentVersion4UpdateLogBinding.inflate(inflater, container, false);
    ...
    private void getHistoryUpdateLog2(View root) {
        ...
        UpdateLogReader.readAssetsTxtAsync(
                requireContext(),
                "HistoryUpdateLog4.txt", // assets下的文件名
