...
public class UsingInstructionDetailActivity extends BaseActivity {
    // 顶部栏滚动联动的状态保存键与渐变区间
    private static final String STATE_SCROLL_Y = "state_using_instruction_detail_scroll_y";
    ...
    private void initDecoration() {
        ...
        // 动态调整侧边距（手机/PAD）
        LinearLayout using_instruction_detail_container = findViewById(R.id.using_instruction_detail_container);
        InsetsUtil.setMarginHorizontal(this, using_instruction_detail_container, layout_marginHorizontal -> {
            ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) using_instruction_detail_container.getLayoutParams();
            params.leftMargin = layout_marginHorizontal;
            params.rightMargin = layout_marginHorizontal;
            using_instruction_detail_container.setLayoutParams(params);
        ...
        topBar.setText(getIntent().getStringExtra("title"));
        topBarBottom.setText(getIntent().getStringExtra("title"));
    }
