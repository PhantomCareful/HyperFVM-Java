...
public class DecomposeAndGetCalculatorForGoldenCardActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decompose_and_get_calculator_for_golden_card);
    ...
    private void initTabLayoutFragments(TabLayoutFragmentStateAdapter adapter) {
        ...
        adapter.addFragment(new DecomposeCalculatorForGoldenCardFragment().newInstance(decomposeItemName, imageIdsArray, decomposeDataArray), getResources().getString(R.string.title_decompose_calculator));
        adapter.addFragment(new GetCalculatorForGoldenCardFragment().newInstance(decomposeItemName, imageIdsArray, getDataArray), getResources().getString(R.string.title_get_calculator));
    }
    ...
    private void initDecoration() {
        ...
        // 动态调整侧边距（手机/PAD）
        ConstraintLayout decompose_and_get_calculator_for_golden_card_container = findViewById(R.id.decompose_and_get_calculator_for_golden_card_container);
        InsetsUtil.setMarginHorizontal(this, decompose_and_get_calculator_for_golden_card_container, layout_marginHorizontal -> {
