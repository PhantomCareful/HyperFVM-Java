...
public class CardDataIndexActivity extends AppCompatActivity {
    ...
    private void initCardImages() {
        ...
        findViewById(R.id.card_data_index_1_3_1_0).setOnClickListener(v -> selectCardDataByName("枪塔喵"));
        findViewById(R.id.card_data_index_1_3_1_1).setOnClickListener(v -> selectCardDataByName("榴弹枪塔喵"));
        findViewById(R.id.card_data_index_1_3_1_2).setOnClickListener(v -> selectCardDataByName("射线枪塔喵"));
        findViewById(R.id.card_data_index_1_3_2_0).setOnClickListener(v -> selectCardDataByName("弩箭牛"));
        findViewById(R.id.card_data_index_1_3_2_1).setOnClickListener(v -> selectCardDataByName("精英弩箭牛"));
        findViewById(R.id.card_data_index_1_3_2_2).setOnClickListener(v -> selectCardDataByName("暴力弩箭牛"));
        findViewById(R.id.card_data_index_1_3_3_0).setOnClickListener(v -> selectCardDataByName("仙人掌刺身"));
        findViewById(R.id.card_data_index_1_3_3_1).setOnClickListener(v -> selectCardDataByName("仙人球刺身"));
        findViewById(R.id.card_data_index_1_3_3_2).setOnClickListener(v -> selectCardDataByName("仙人掌花刺身"));
