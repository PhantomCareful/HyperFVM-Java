...
public class CardDataIndexActivity extends BaseActivity {
    ...
    private void initCardImages() {
        ...
        findViewById(R.id.card_data_index_11_2_1).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "天蝎座精灵"));
        findViewById(R.id.card_data_index_11_2_2).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "工程猪"));
        findViewById(R.id.card_data_index_11_2_3).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "双刃蛇"));
        findViewById(R.id.card_data_index_11_2_4).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "元素蛇"));
        findViewById(R.id.card_data_index_11_2_5).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "回旋虎"));
        findViewById(R.id.card_data_index_11_2_6).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "大师兔"));
        findViewById(R.id.card_data_index_11_2_7).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "15周年猴赛雷"));
        findViewById(R.id.card_data_index_11_2_8).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "赖皮蛇"));
        findViewById(R.id.card_data_index_11_2_9).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "迷你披萨炉"));
        findViewById(R.id.card_data_index_11_3_1).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "焦油喷壶"));
        findViewById(R.id.card_data_index_11_3_2).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "喷壶汪"));
        findViewById(R.id.card_data_index_11_3_3).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "派派鸡"));
        findViewById(R.id.card_data_index_11_3_4).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "小猪米花机"));
        findViewById(R.id.card_data_index_11_3_5).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "喷气牛"));
        findViewById(R.id.card_data_index_11_3_6).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "卖萌喵"));
        findViewById(R.id.card_data_index_11_3_7).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "奥丁神使"));
        findViewById(R.id.card_data_index_11_3_8).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "阴阳蛇"));
        findViewById(R.id.card_data_index_11_3_9).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "法师蛇"));
        findViewById(R.id.card_data_index_11_3_10).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "街头烤肉大师"));
        findViewById(R.id.card_data_index_11_3_11).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "后羿神使"));
        ...
        findViewById(R.id.card_data_index_12_1_3).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "巧克力大炮"));
        findViewById(R.id.card_data_index_12_1_4).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "导弹蛇"));
        findViewById(R.id.card_data_index_12_1_5).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "盖亚神使"));
        ...
        findViewById(R.id.card_data_index_14_1_2).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "13周年时光机"));
        findViewById(R.id.card_data_index_14_1_3).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "转龙壶"));
        findViewById(R.id.card_data_index_14_1_4).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "顽皮龙"));
        findViewById(R.id.card_data_index_14_1_5).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "美味计时器"));
        findViewById(R.id.card_data_index_14_1_6).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "柯罗诺斯神使"));
        findViewById(R.id.card_data_index_14_1_7).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "克洛托神使"));
        findViewById(R.id.card_data_index_14_1_8).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "蛇蛇酒"));
        findViewById(R.id.card_data_index_14_1_9).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "幻幻鸡"));
        findViewById(R.id.card_data_index_14_1_10).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "圣诞包裹"));
        findViewById(R.id.card_data_index_14_1_11).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "天使猪"));
        findViewById(R.id.card_data_index_14_1_12).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "黯然销魂饭"));
        findViewById(R.id.card_data_index_14_1_13).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "梵天神使"));
        findViewById(R.id.card_data_index_14_1_14).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "百变蛇"));
        ...
        findViewById(R.id.card_data_index_14_3_1).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "木塞子"));
        findViewById(R.id.card_data_index_14_3_2).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "防风草沙拉"));
        findViewById(R.id.card_data_index_14_3_3).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "金箔甜筒"));
        findViewById(R.id.card_data_index_14_3_4).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "治愈喵"));
        findViewById(R.id.card_data_index_14_3_5).setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "12周年能量饮料"));
