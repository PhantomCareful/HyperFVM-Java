...
public class AuxiliaryList10Activity extends BaseActivity {
    private ActivityAuxiliaryList10Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auxiliary_list10);

        // 初始化ViewBinding
        binding = ActivityAuxiliaryList10Binding.inflate(getLayoutInflater());
