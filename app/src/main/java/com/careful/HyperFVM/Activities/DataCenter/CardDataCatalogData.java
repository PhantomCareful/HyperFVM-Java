 ...
 * 防御卡目录页面的静态数据表。
 * <p>
 * 分节相关的所有静态配置都集中在这里，三个集合长度均为 47、下标即分节号（从 0 开始），
 * 增删分节时三个集合需按同一位置同步增删：
 * <ul>
 ...
 * <p>
 * 注意 2：strings.xml 中分节标题资源存在历史命名错位
 * （13_x 系资源名为 text_data_images_index_card_12__n，
...
public final class CardDataCatalogData {
    ...
    public static final String[][] SECTION_NAMES = {
            ...
            /* 16_1 */ {"火炉菠萝面包", "雪芭煮蛋器", "火影怪味鱿鱼", "酱香锅烤栗子", "热狗耗油双菇", "子母三线酒架", "刺梨烧烤盘", "机枪咖啡杯", "葡萄味软糖", "脆心死神大炮", "仙人球海星刺身", "红温旋转咖啡壶"}
    };
