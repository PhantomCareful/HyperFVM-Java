...
public class Version1UpdateLogFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //初始化binding
        FragmentVersion1UpdateLogBinding binding = FragmentVersion1UpdateLogBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        //显示历史版本更新日志
        TextView currentUpdateLog = root.findViewById(R.id.about_app_history_update_log_1);
        getContentFromAssets(requireContext(), currentUpdateLog, "HistoryUpdateLog1.txt");
