...
public class AuxiliaryList1Activity extends BaseActivity {
    private ActivityAuxiliaryList1Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auxiliary_list1);

        // 初始化ViewBinding
        binding = ActivityAuxiliaryList1Binding.inflate(getLayoutInflater());
