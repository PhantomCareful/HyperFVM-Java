...
public class DecomposeCalculatorForAnimalCardFragment extends Fragment {
    ...
    private void initDecoration() {
        // 动态调整侧边距（手机/PAD）
        LinearLayout decompose_calculator_for_animal_card_container = root.findViewById(R.id.decompose_calculator_for_animal_card_container);
        CardView decompose_calculator_for_animal_card_result_container = root.findViewById(R.id.decompose_calculator_for_animal_card_result_container);
        InsetsUtil.setMarginHorizontal(requireActivity(), decompose_calculator_for_animal_card_container, layout_marginHorizontal -> {
            Log.d("updateLog", String.valueOf(layout_marginHorizontal));
            ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) decompose_calculator_for_animal_card_container.getLayoutParams();
            params.leftMargin = layout_marginHorizontal;
            params.rightMargin = layout_marginHorizontal;
            decompose_calculator_for_animal_card_container.setLayoutParams(params);

            params = (ViewGroup.MarginLayoutParams) decompose_calculator_for_animal_card_result_container.getLayoutParams();
            params.leftMargin = layout_marginHorizontal;
            params.rightMargin = layout_marginHorizontal;
            decompose_calculator_for_animal_card_result_container.setLayoutParams(params);
        });
        // 添加模糊材质
        setupBlurEffect();
    }
