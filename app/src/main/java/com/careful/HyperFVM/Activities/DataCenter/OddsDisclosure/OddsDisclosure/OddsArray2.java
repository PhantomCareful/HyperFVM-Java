...
public class OddsArray2 {
    ...
    public static OddsItem[] array1 = {
            ...
            new OddsItem("恶作剧神三转套餐", 1, R.drawable.transfer_box_golden_card_3, false, 0.2000),
            new OddsItem("巨神三转套餐", 1, R.drawable.transfer_box_golden_card_3, false, 0.2000),
            new OddsItem("宴飨女神三转套餐", 1, R.drawable.transfer_box_golden_card_3, false, 0.1200),
            new OddsItem("创造神三转套餐", 1, R.drawable.transfer_box_golden_card_3, false, 0.0300),
    ...
    public static OddsItem[] array3 = {
            new OddsItem("一转傀儡马礼包(傀儡马(0星，30天，绑定)×1、傀儡马一转套餐×1)", 1, R.drawable.transfer_bag_horse_1, true, 0.0250),
            new OddsItem("傀儡马二转套餐", 1, R.drawable.transfer_bag_horse_2, true, 0.0100),
