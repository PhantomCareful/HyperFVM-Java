...
public class AuxiliaryList8Activity extends BaseActivity {
    private ActivityAuxiliaryList8Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化ViewBinding
        binding = ActivityAuxiliaryList8Binding.inflate(getLayoutInflater());
    ...
    private void initCardImages() {
        ...
        Objects.requireNonNull(binding.cardCardDataAuxiliaryList8).cardCardDataIndex946.cardDataIndex946.setOnClickListener(v -> CardDataHelper.selectCardDataByName(this, "红柳烤串机"));
        // 魔杖蛇和海洋女神追加
