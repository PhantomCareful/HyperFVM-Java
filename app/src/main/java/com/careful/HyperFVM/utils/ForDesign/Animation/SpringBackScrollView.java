...
public class SpringBackScrollView extends ScrollView {
    ...
    private void boundBack() {
        ...
        if (deltaY > 0 && mPullRefreshListener != null) {
    ...
    public void setListViewListener(IPullRefreshListener mListViewListener) {
        this.mPullRefreshListener = mListViewListener;
    }
