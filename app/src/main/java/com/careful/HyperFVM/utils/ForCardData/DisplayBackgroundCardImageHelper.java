...
public class DisplayBackgroundCardImageHelper {
    private static final String[][] CardImageFileNameArray = {
            ...
            {"card_data_index_1_3_1_0_big", "小笼包", "card_data_1"},
            {"card_data_index_1_3_2_0_big", "双层小笼包", "card_data_1"},
            {"card_data_index_1_3_3_0_big", "三向小笼包", "card_data_1"},
            {"card_data_index_1_3_4_2_big", "机枪小笼包", "card_data_1"},
            {"card_data_index_1_3_5_0_big", "冰冻小笼包", "card_data_1"},
            {"card_data_index_1_3_6_0_big", "双层冰冻小笼包", "card_data_1"},
            {"card_data_index_1_3_7_0_big", "三向冰冻小笼包", "card_data_1"},
            {"card_data_index_1_3_8_0_big", "机枪冰冻小笼包", "card_data_1"},
            {"card_data_index_1_3_9_2_big", "国王小笼包", "card_data_1"},
            {"card_data_index_1_3_10_2_big", "三向国王小笼包", "card_data_1"},
            {"card_data_index_1_3_11_0_big", "贵族小笼包", "card_data_1"},
            {"card_data_index_1_3_12_2_big", "玉蜀黍", "card_data_1"},
            {"card_data_index_1_3_13_2_big", "包包龙", "card_data_4"},
            {"card_data_index_1_3_14_2_big", "咖啡杯", "card_data_1"},
            {"card_data_index_1_3_15_0_big", "水上茶杯", "card_data_1"},
            {"card_data_index_1_3_16_2_big", "激光汪", "card_data_4"},

            {"card_data_index_1_4_1_2_big", "枪塔喵", "card_data_4"},
            {"card_data_index_1_4_2_2_big", "弩箭牛", "card_data_4"},
            {"card_data_index_1_4_3_2_big", "仙人掌刺身", "card_data_1"},
            ...
            {"card_data_index_2_2_14_2_big", "色拉投手", "card_data_1"},
            {"card_data_index_2_2_15_2_big", "巧克力投手", "card_data_1"},
            {"card_data_index_2_2_16_2_big", "臭豆腐投手", "card_data_1"},
            {"card_data_index_2_2_17_2_big", "8周年蛋糕", "card_data_1"},

            {"card_data_index_2_3_1_2_big", "生煎锅", "card_data_1"},
            {"card_data_index_2_3_2_2_big", "铛铛虎", "card_data_4"},
            {"card_data_index_2_3_3_2_big", "祝融神使", "card_data_3"},
            {"card_data_index_2_3_3_3_big", "祝融神使", "card_data_3"},
            {"card_data_index_2_3_4_2_big", "糖炒栗子", "card_data_1"},
            {"card_data_index_2_3_5_2_big", "霜霜蛇", "card_data_4"},
            {"card_data_index_2_3_6_2_big", "马卡龙烤箱", "card_data_1"},
            ...
            {"card_data_index_3_2_5_2_big", "邪恶牛油果", "card_data_1"},
            {"card_data_index_3_2_6_2_big", "怪味鱿鱼", "card_data_1"},
            {"card_data_index_3_2_7_2_big", "烟花虎", "card_data_4"},
            {"card_data_index_3_2_8_2_big", "风车龙", "card_data_4"},
            {"card_data_index_3_2_9_2_big", "元宝饺子鼎", "card_data_1"},
            ...
            {"card_data_index_8_1_5_2_big", "肥牛火锅", "card_data_1"},
            {"card_data_index_8_1_6_2_big", "麻辣香锅", "card_data_1"},
            ...
            {"card_data_index_9_4_1_2_big", "金刚马", "card_data_4"},
            {"card_data_index_9_4_2_2_big", "红柳烤串机", "card_data_1"},
            {"card_data_index_9_4_3_2_big", "俱吠罗神使", "card_data_3"},
            {"card_data_index_9_4_3_3_big", "俱吠罗神使", "card_data_3"},

            {"card_data_index_9_5_1_1_big", "鼠鼠蛋糕空投器", "card_data_1"},
            {"card_data_index_9_5_2_2_big", "风力空投猪", "card_data_4"},
            {"card_data_index_9_5_3_2_big", "电流虎", "card_data_4"},
            {"card_data_index_9_5_4_2_big", "霹雳马", "card_data_4"},
            {"card_data_index_9_5_5_2_big", "归元马", "card_data_4"},
            {"card_data_index_9_5_6_2_big", "蜜糖陷阱", "card_data_1"},
            {"card_data_index_9_5_7_2_big", "仙笛马", "card_data_4"},
            {"card_data_index_9_5_8_2_big", "萌海马", "card_data_4"},

            {"card_data_index_10_1_1_2_big", "汉堡包", "card_data_1"},
            {"card_data_index_10_1_2_0_big", "贪食娃", "card_data_1"},
            {"card_data_index_10_1_3_2_big", "吞噬龙", "card_data_4"},
            {"card_data_index_10_1_4_2_big", "香辣年糕蟹", "card_data_1"},
            {"card_data_index_10_1_5_2_big", "混沌神使", "card_data_3"},
            {"card_data_index_10_1_5_3_big", "混沌神使", "card_data_3"},

            {"card_data_index_10_2_1_2_big", "雷电长棍面包", "card_data_1"},
            {"card_data_index_10_2_2_2_big", "三指兔", "card_data_4"},
            {"card_data_index_10_2_3_2_big", "结界马", "card_data_4"},
            ...
            {"card_data_index_11_3_6_2_big", "云霞马", "card_data_4"},
            {"card_data_index_11_3_7_2_big", "回旋虎", "card_data_4"},
            {"card_data_index_11_3_8_2_big", "大师兔", "card_data_4"},
            {"card_data_index_11_3_9_2_big", "15周年猴赛雷", "card_data_1"},
            {"card_data_index_11_3_10_2_big", "赖皮蛇", "card_data_4"},
            {"card_data_index_11_3_11_2_big", "迷你披萨炉", "card_data_1"},
            ...
            {"card_data_index_12_1_1_2_big", "巧克力大炮", "card_data_1"},
            {"card_data_index_12_1_2_2_big", "导弹蛇", "card_data_4"},
            {"card_data_index_12_1_3_2_big", "盖亚神使", "card_data_3"},
            {"card_data_index_12_1_3_3_big", "盖亚神使", "card_data_3"},
            ...
            {"card_data_index_13_2_10_2_big", "泡椒春笋", "card_data_1"},
            {"card_data_index_13_2_11_2_big", "奇门马", "card_data_4"},
            ...
            {"card_data_index_15_2_6_0_big", "生日帽", "card_data_1"},
