...
public class CardDataCoolDownAndUpgradeAndDriveFogAndClearObstacleAndSpecialEffectFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.card_data_img_cool_down_and_upgrade_and_drive_fog_and_clear_obstacle_and_special_effect);
