...
public class CardDataCardFusionFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.card_data_img_card_fusion);
    ...
    // 持有接口实例（由父Fragment实现）
    private OnBackToIndexCallback callback;
    // 绑定接口实现（通常在父Fragment中调用）
    public void setOnBackToIndexCallback(OnBackToIndexCallback callback) {
