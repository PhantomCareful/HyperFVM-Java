...
public class CardDataBreadCommonAndBreadMiddleAndGuardProtectorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.card_data_img_bread_common_and_bread_middle_and_guard_protector);
