...
import com.careful.HyperFVM.databinding.FragmentDataStationThirdNotMoluBinding;
import com.careful.HyperFVM.utils.OtherUtils.ImageViewerUtil;

public class WorldBossLevelFragment extends Fragment {

    private FragmentDataStationThirdNotMoluBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentDataStationThirdNotMoluBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        ImageView imageView = root.findViewById(R.id.Image_View);
        imageView.setImageResource(R.drawable.other_world_boss_level);
